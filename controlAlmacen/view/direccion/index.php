                    ...
                    <div class="btn-group pull-right">
                      <b>
                        ...
                        <div class="btn-group" style="margin-right: 10px;">
                          <a class="btn btn-sm btn-success tooltips" href="?c=Direccion&a=Crud" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Registrar nuevo Departamento"> <i class="fa fa-plus"></i> Registrar </a>
          ...
          <div class="modal-content  panel default red_border horizontal_border_1">
            <div class="modal-body">
              <div class="row">
                <div class="block-web">
                  <div class="header">
                    <h3 class="content-header theme_color">&nbsp;Eliminar Departamento</h3>
                  </div>
                  <div class="porlets-content" style="margin-bottom: -50px;">
                    <h4>¿Esta segúro que desea eliminar el Departamento?</h4>
                  </div><!--/porlets-content-->
                </div><!--/block-web-->
              </div>
            </div>
