part <div class="pull-left breadcrumb_admin clear_both">
...
<div class="container clear_both padding_fix">
        ...
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header theme_color" style="margin-top: -5px;">Registrar Parida Mensual</h2>
            </div>
            <div class="col-md-4">
  ...
  <div class="form-group">
            <label class="col-sm-3 control-label">Mes de Partida:<strog class="theme_color">*</strog></label>
            <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
               <input autofocus name="idLocalidad" id="idLocalidad" parsley-type="number" class="form-control" required value="" placeholder="Partida" />
             </div>
           </div><!--/form-group-->
           <div class="form-group">
